...
``` {r example-plot-re-unc, out.width = '100%', fig.width=16}
...
``` {r intuition-plot, out.width = '100%', fig.width=16}
...
``` {r data-cb-nrec, out.width = '100%', fig.width=16}
...
``` {r sim2-corr-stan-plots, out.width = '100%', fig.width=16}
...
``` {r sim2-corr-stan-plots2, out.width = '100%', fig.width=16}
...
``` {r data-it-nrec, out.width = '100%', fig.width=16}
...
``` {r res-sim2-hs-all-plots-tmb, out.width = '100%'}
...
``` {r res-sim6-corrre-low-old, out.width = '100%'}
...
``` {r res-sim6-corrre-eas, out.width = '100%'}
load(file.path('./Git/MixedModels_Biases/', 'results',
